  ...
  return (
    ...
    >
      ...
      <div className="w-full grid grid-cols-2 gap-4 items-center">
        <div className="w-full size-14 border border-dashed border-black/25 flex flex-col items-center justify-center relative rounded-lg overflow-hidden">
          <input
            type="file"
            id="media"
          ...
          <div className="size-full flex gap-3 items-center justify-between p-4 cursor-pointer">
            <svg
              viewBox="0 0 512 512"
              className="size-6 min-w-fit fill-black/50 cursor-pointer"
            >
              <path d="M288 109.3L288 352c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-242.7-73.4 73.4c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l128-128c12.5-12.5 32.8-12.5 45.3 0l128 128c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L288 109.3zM64 352l128 0c0 35.3 28.7 64 64 64s64-28.7 64-64l128 0c35.3 0 64 28.7 64 64l0 32c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64l0-32c0-35.3 28.7-64 64-64zM432 456a24 24 0 1 0 0-48 24 24 0 1 0 0 48z" />
            </svg>
            <p className="text-black/50 w-full overflow-hidden text-nowrap text-ellipsis">
              {fileName}
            </p>

            <button
              type="button"
              className="min-w-fit relative z-20 bg-gray p-1.5 rounded-md"
            >
              <svg viewBox="0 0 384 512" className="size-4 fill-blue">
