const Footer = () => {
  return (
    <footer className="w-full relative flex flex-col items-center lg:px-4 px-3">
      <div className="max-w relative p-3 flex gap-3 justify-between items-center border-1.5 border-black/10 border-b-0 rounded-t-lg">
        <p className="sm:text-lg xs:text-base text-sm leading-snug mt-0.5">
        ...
        <div className="flex sm:gap-4 gap-3 items-center">
          ...
          <a
            ...
            target="_blank"
          >
            <svg viewBox="0 0 496 512" className="icon-svg">
          ...
          <a
            href="https://twitter.com/mbilalmansuri"
            className="icon-black"
            target="_blank"
          >
