  ...
  return (
    <header className="w-full fixed top-0 z-40 flex flex-col items-center px-3">
      <div className="max-w relative md:h-16 h-14 p-3 flex justify-between items-center border-1.5 border-t-0 border-black/10 bg-white rounded-b-lg">
        ...
        <nav className="flex items-center md:gap-4 gap-3">
          {isLoggedIn ? (
            <>
              {isVerified && (
                <>
                  ...
                  >
                    <svg viewBox="0 0 576 512" className="md:size-4 size-3.5">
                  ...
                  >
                    <svg viewBox="0 0 448 512" className="md:size-4 size-3.5">
              ...
              >
                {loggingOut ? (
                  ...
                  <svg viewBox="0 0 512 512" className="md:size-4 size-3.5">
              ...
              {isVerified && (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      "icon md:text-base text-sm leading-none bg-blue text-white hover:bg-blue/85 font-zen-dots",
