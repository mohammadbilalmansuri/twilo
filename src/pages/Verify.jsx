...
const Verify = () => {
  ...
  return (
    <>
      ...
      <div className="wrapper-center py-8 text-center gap-4">
        <svg viewBox="0 0 640 512" className="h-16 mb-1 fill-blue">
        ...
        <p className="text pb-2">Check your email for the verification link.</p>
        <Button
          style="secondary"
